          ...
          <div className="mx-3 sm:mx-12 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12 ">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="text-yellow-600 mb-4 block text-base font-semibold">
                  {t("Contact.contact")}
                </span>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="bg-yellow-600 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
