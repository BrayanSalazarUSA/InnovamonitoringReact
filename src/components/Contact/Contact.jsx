...
const Contact = () => {
  ...
  return (
    ...
    <Navbar efecto="efecto2"></Navbar>
      <section class="overflow-hidden  py-20 lg:pt-[95px] ">
        <div class="container mx-auto">
          <div class="mx-3 sm:mx-12 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12 ">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <span class="text-yellow-600 mb-4 block text-base font-semibold">
                  {t("Contact.contact")}
                </span>
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    <h4 class="text-gray-700 mb-1 text-xl font-bold">
                    {t("Contact.location")}
                    </h4>
                    <p class="text-gray-700 text-base py-0">
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-gray-700 text-base py-0">{t("Contact.phoneNumber")}</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-yellow-600 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
            ...
            <div class="w-full  px-4 lg:w-1/2 xl:w-5/12 ">
              <div class="relative rounded-lg p-8 shadow-lg sm:p-12 contact">
                <form ref={refForm} onSubmit={sendEmail} >
                  ...
                  <div>
                    <button
                      type="submit"
                      class="bg-yellow-700  w-full rounded  p-3 text-white transition hover:bg-opacity-90"
                    >
                      {t("buttons.message")}
                    </button>
                  </div>
